...
class MasterAgent:
    ...
    async def fetch_data_only(self, params: Dict[str, Any], data_source: str) -> AggregatedDataResponse:
        """
        Fetch only raw data without performing analysis from a specific data source.
        """
        # Check cache first
        ...
        agent = agent_class()
        result = await self._fetch_from_agent(agent_class, params)
